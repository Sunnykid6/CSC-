...
/**
 * DrawableBTree class is a class created specifically for 
 * University of Victoria students in CSC115 
 * to visualize an existing BinaryTree structure.
 ...
 * 
 * This java code is open source and may be used as a teaching tool 
 * in an educational setting.
 * Modifications are encouraged, but should include credit to the
 * original author.
 * Please do not post this code or any modification on an open public 
 * forum without written consent from the author.
 *
 * @author Dr. Bette Bultena
